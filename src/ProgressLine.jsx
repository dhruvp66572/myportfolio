    ...
    <>
      ...
      >
        {visualParts.map((item, index) => {
            const per = (parseInt(item.percentage.slice(0,-1)) - 8 )+"px"
            // console.log(per-8) 
          ...
          return (
            ...
            {/* <span className="progressVisualPartLabel" style={{marginLeft:per, backgroundColor:"transparent"}}>{item.percentage}
            </span> */}
            <div
